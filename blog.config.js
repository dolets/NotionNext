...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'DoLets', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '多乐事🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://dolets.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'DOLETS, 多乐事', // 网站关键词 英文逗号隔开
